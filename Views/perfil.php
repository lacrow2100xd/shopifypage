    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form-datos" enctype="multipart/form-data">
          ...
          <div class="form-group">
              <label for="cedula_mod">Cedula</label>
              <input type="text" name="cedula_mod" class="form-control" id="cedula_mod" placeholder="Ingrese cedula">
          </div>
          <div class="form-group">
          ...
          <div class="col-md-3">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header bg-info">
                ...
                <h5 class="widget-user-desc" id="tipo_usuario"></h5>
              </div>
              <div class="widget-user-image">
                <img id="avatar_perfil" class="img-circle elevation-2" src="../Util/Img/default.png" alt="User Avatar">
              </div>
            ...
            <div class="card card-light">
                ...
                <div class="card-body pt-0 mt-2">
                  <div class="row">
                    <div class="col-8">
                      <h2 class="lead" id="nombres"></b></h2>
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-address-card"></i></span>Cedula:<span id="cedula" ></span></li>
                    ...
                    <div class="col-4 text-center">
                      <img src="../Util/Img/informacion-personal.png" alt="user-avatar" class=" img-fluid">
                    </div>
                  </div>
                </div>
              ...
              <div class="card card-light">
                ...
                <div id="direcciones"class="card-body pt-0 mt-2">
              ...
              <div class="card card-light">
                <div class="card-header text-muted border-bottom-0">
                  <strong>tarjetas de pago</strong>
                  <div class="card-tools">
                ...
                <div class="card-body pt-0 mt-2">
                  <div class="row">
                    ...
                    <div class="col-4 text-center">
                      <img src="../Util/Img/tarjeta-de-credito.png" alt="user-avatar"  class="img-fluid">
                    </div>
                  </div>
                </div>
