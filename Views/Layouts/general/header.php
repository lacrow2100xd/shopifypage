...
<head>
  ...
  <link rel="stylesheet" href="../Util/Css/estilos.productos.css">

  <link rel="stylesheet" href="../Util/Css/body-index.css">

  <link rel="stylesheet" href="../Util/Css/productos.css">

  <link rel="stylesheet" href="../Util/Css/vender.css">
...
<header>
  <div class="container-buscador">
    ...
    <div class="separador">
      <li class="nav-iniciar-sesion" id="nav-iniciar-sesion"><a href="registro.php" class="nav-link proxima-nova">Crea tu cuenta</a></li>
      ...
      <div class="container-icon" id="nav-carrito">
        ...
        <svg
          ...
          <form id="detallespedidoproductos">
      ...
      <li class="nav-item-dropdown" id="nav-login">
        <a href="login.php" class="nav-link" >Favoritos</a>
      </li>
