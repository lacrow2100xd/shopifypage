$(document).ready(function () {
    ...
    swalWithBootstrapButtons
      ...
      .then((result) => {
        if (result.isConfirmed) {
          ...
          $.post(
            "../Controllers/usuario.municipio.php",
            { funcion, id },
            (response) => {
              if (response == "success") {
  ...
  function llenar_departamentos() {
    ...
    $.post(
      "../Controllers/departamento.controller.php",
      { funcion },
      (response) => {
  ...
  $("#departamento").change(function () {
    ...
    $.post(
      "../Controllers/municipios.controller.php",
      { funcion, departamento_id },
      (response) => {
...
// $('#form_pedido').submit(e =>{

//     funcion = 'insertar_pedido';

//     let montopedido=$('#montototal').val(total);
